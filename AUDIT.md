...
_Date: 2026-06-10 (statuses last updated 2026-07-07)_
...
| 16 | ✅ Fixed | **No "drag to reposition" when editing a spot** | Add/Edit modal | The modal now drops a draggable marker at the pending/spot location (add and edit flows, and after a Google Maps paste); dragging it live-updates the coordinates shown and saved. |
